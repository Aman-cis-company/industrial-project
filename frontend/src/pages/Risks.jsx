  ...
  const fetchData = async () => {
    try {
      ...
      setRisks([
        ...
        { id: 4, title: 'Contract currency exchange fluctuation (EUR/USD)', description: 'Risk of financial loss due to contract payment currency terms.', category: 'Financial', probability: 1, impact: 2, riskScore: 2, status: 'Closed', mitigationPlan: 'Hedge transaction values inside local bank contracts.', identifiedDate: '2026-01-20', project: { id: 2, name: 'King Salman Park Infrastructure Master Plan' }, owner: { user: { name: 'Sarah Jenkins' } } }
      ]);
      setCompliance([
